...
async def pro_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    app.add_handler(CommandHandler("start", process_message))
    app.add_handler(CommandHandler("gpt4", process_message))
    app.add_handler(CommandHandler("gpt2", process_message))
    app.add_handler(CommandHandler("gog", process_message))
    app.add_handler(CommandHandler("ht", process_message))
...
def register_auxiliary_handlers(app):
    ...
    app.add_handler(CommandHandler("proverka", proverka_handler))
    app.add_handler(CommandHandler(SECRET_STOP_COMMAND.lstrip("/"), stopbot_handler))
